...
- (void)viewDidLoad {
    ...
    fol.likeCount = @"2,400 Likes";
    [self.following addObject:fol];
    
    fol = [[Following alloc] init];
    fol.username = @"ManofSteel";
    fol.dateUploaded = @"20 min";
    fol.videoFile = [[NSBundle mainBundle] URLForResource:@"featured_2" withExtension:@"gif"];
    fol.description = @"8 reps on each side";
    fol.profilePic = @"manprofileimage.jpg";
    fol.usernameCom = @"ManofSteel";
    fol.likeCount = @"4,000 Likes";
    [self.following addObject:fol];
